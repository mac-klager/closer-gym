...
- Rapport and framing already happened before the call started, so they're warm and ready to engage — but "ready to talk" is NOT "ready to buy". They still don't volunteer the deep stuff.
- They answer the first version of any question SHORT and surface-level: "It's alright", "Yeah pretty much", "Just want more for myself I guess."
- The real reasons come out only after 2-3 layers of follow-up questions ("what do you mean by that?", "how long has that been going on?", "how does that actually affect you?").
...
Rapport is done — when the rep asks their first real question (the intent question), you're warm and willing to answer. Depth is still earned from there.
1. INTENT → asked the real reason they want to change right now, they give an honest but still surface-level answer ("just want more freedom", "tired of where I'm at").
2. CRACK → a good follow-up ("what do you mean by that?" / "why now though, what changed?") gets the first genuinely honest sentence.
